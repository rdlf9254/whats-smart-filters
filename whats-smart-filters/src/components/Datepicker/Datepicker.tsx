        ...
        <div className="cal">
          <div className="cal-month">
            ...
            <select className="form-select cal-month-name d-none">
              ...
              <option selected={true} value="June">June</option>
          ...
          <div className="cal-days">
            <button className="btn cal-btn" disabled={true} type="button">30</button>
            <button className="btn cal-btn" disabled={true} type="button">31</button>
